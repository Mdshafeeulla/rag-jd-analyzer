...
3. **Retrieve** — Hybrid BM25 + cosine similarity finds the most JD-relevant resume sections
...
| Vector Search | Hybrid BM25 + semantic retrieval (NumPy) |
...
python main.py --resume data/resume.txt --jd data/jd.txt --semantic_weight 0.6
```
...
│   ├── vector_store.py   # Hybrid BM25 + cosine similarity search
